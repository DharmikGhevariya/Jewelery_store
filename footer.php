	...
	<footer>
            <div class="container">
                <div class="row m_t20">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <p><strong>HELP WITH SIZING?</strong><br><a>View Our Size Guide</a></p>
                        <div class="bookings">
                            <p><strong>BOOKINGS AND ENQUIRIES</strong><br><a>dharmikg@gmail.com</a></p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-4 newsletter-form">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-2 social-icons">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="copyright">
                            © Designed by <a>Dharmik Ghevariya</a> @2024
                        </div>
                    </div>
                </div>
            </div>
